...
const soucreConfig = {
    ...
    dev: {
        ...
        // 國內自由行.台灣 搜尋面板
        'vacation.taiwan.search': {
            departure: './json/departurelocaltw.json',
            destinationS: './json/destinationlocalTW_S.json',
            destination: './json/destinationlocalTW.json',
    ...
    demo: {
        ...
        'vacation.taiwan': {
            ...
            traffic: '/Content/F2E/plugins/searchpanel/json/traffic.json'
        },
        // 國內自由行.台灣 搜尋面板
        'vacation.taiwan.search': {
            departure: '/Content/F2E/plugins/searchpanel/json/departurelocaltw.json',
            destinationS: '/Content/F2E/plugins/searchpanel/json/destinationlocalTW_S.json',
            destination: '/Content/F2E/plugins/searchpanel/json/destinationlocalTW.json',
            traffic: '/Content/F2E/plugins/searchpanel/json/traffic.json'
        },
        // 主題旅遊
        themeTravel: {
    ...
    rel: {
        ...
        // 國內自由行.台灣 搜尋面板
        'vacation.taiwan.search': {
            departure: 'https://uvacation.liontravel.com/gendata/jsondata/departurelocaltw',
            destinationS: 'https://uvacation.liontravel.com/gendata/jsondata/destinationlocaltw_s',
            destination: 'https://uvacation.liontravel.com/gendata/jsondata/destinationlocaltw',
            traffic: 'https://uvacation.liontravel.com/gendata/jsondata/traffictype'
        },
        // 主題旅遊
        themeTravel: {
    ...
    prod: {
        ...
        // 國內自由行.台灣 搜尋面板
        'vacation.taiwan.search': {
            departure: '//vacation.liontravel.com/gendata/jsondata/departurelocaltw',
            destinationS: '//vacation.liontravel.com/gendata/jsondata/destinationlocaltw_s',
            destination: '//vacation.liontravel.com/gendata/jsondata/destinationlocaltw',
            traffic: '//vacation.liontravel.com/gendata/jsondata/traffictype'
        },
        // 主題旅遊
        themeTravel: {
...
export const vacationTaiwanSearch = sourcePath['vacation.taiwan.search'];
