        ...
        return (
            <NtbRcln customClass="search_panel_one search_panel_all_mobile" activeTabIndex={show} onClick={(i) => this.setState({ show: i })}>
                <Tab label="團體">
                    ...
                    {show === 0 && LoadComponent(import(/* webpackChunkName: "travel-m" */ '../../travel/mobile'))}
                </Tab>
                <Tab label="機票">
                    {show === 1 && LoadComponent(import(/* webpackChunkName: "flight-m" */ '../../flight/international/mobile'))}
                </Tab>
                <Tab label="訂房">
                    {show === 2 && LoadComponent(import(/* webpackChunkName: "hotel-m" */ '../../hotel/mobile'))}
                </Tab>
                <Tab label="自由行">
                    <NtbRcln customClass="search_panel_two" onClick={(i) => this.setState({ show: 30 + i })}>
                        <Tab label="國外">
                            <NtbRcln activeTabIndex={0} customClass="search_panel_three">
                                <Tab label={<Label3 />}>
                                    {(show === 3 || show === 30) && LoadComponent(import(/* webpackChunkName: "personalVacation-pc" */ '../../vacation/personal/mobile'))}
                                </Tab>
                                <Tab label={<Label4 />}>
                                    {(show === 3 || show === 30) && LoadComponent(import(/* webpackChunkName: "groupVacation-m" */ '../../vacation/group/mobile'))}
                                </Tab>
                            </NtbRcln>
                        </Tab>
                        <Tab label="國內">
                            {show === 31 && LoadComponent(import(/* webpackChunkName: "taiwanVacation-m" */ '../../vacation/taiwan/mobile'))}
                        </Tab>
                    </NtbRcln>
                </Tab>
                <Tab label={<span><span className="search_panel-block">主題</span>旅遊</span>}>
                    {show === 4 && LoadComponent(import(/* webpackChunkName: "themeTravel-m" */ '../../themeTravel/mobile'))}
                </Tab>
                <Tab label={<span><span className="search_panel-block">票券</span>當地遊</span>}>
                    {show === 5 && LoadComponent(import(/* webpackChunkName: "activity-m" */ '../../activity/mobile'))}
                </Tab>
            </NtbRcln>
        );
    }
