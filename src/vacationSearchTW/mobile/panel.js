...
class Panel extends Component {
    ...
    componentDidMount () {
        const url = 'https://www.liontravel.com/webft/webftse01.aspx?Departure=TW_TPE_TPE&Destination=TW_MZG_9&roomlist=2-1-0&roomage=2-,-&Days=2&Keywords=&FromDate=20190210&ToDate=20190220&Traffic=TRA,THSR&noHotel=0';
    ...
    transformUrl (url) {
        ...
        result.map(e => this.setState({ [e[0]]: e[1] }));
    }
    ...
    keyWordPageConfirm = (e) => {
        this.setState({ Keywords: e.inputText });
    }
    ...
    render () {
        return (
            <div className="tw_vacation_search_mb">
                ...
                {/* 間數/人數 */}
                <RoomPeopleM customClass={'mb_RoomPeople'} noHotel={Number(this.state.noHotel)} setPanelState={this.setPanelState} />

                {/* 交通工具 */}
                <TransportM customClass={'mb_Transport'} setPanelState={this.setPanelState} />

                {/* 關鍵字 */}
                <KeywordPlaceM customClass={'mb_KeywordPlace'}
